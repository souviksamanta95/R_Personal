...
library(quantmod)
getSymbols("^BSESN",src="yahoo" , from ="2019-10-23", to = Sys.Date())
View(BSESN)
getSymbols("^NSEI", src="yahoo" , from ="2019-10-23", to = Sys.Date())
View(NSEI)
getSymbols("HDFCBANK.NS", src="yahoo" , from ="2019-10-23", to = Sys.Date())
